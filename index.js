...
// (function(){
//     rod=localStorage.getItem(s_name);
//     maxscore=localStorage.getItem(s_score);

//     if(rod==="null" || maxscore==="null")
//     {
//         alert("This is your first time you are playing Ping Pong.LET'S START");
//         maxscore=0;
//         rod=rod1;
//     }else{
//         alert(rod+"has maximum score of"+maxscore*100);
...
// function resetBord(rodName)
// {
//     rod1.style.left=(window.innerWidth - rod1.offsetWidth)/2+'px';
//     rod2.style.left=(window.innerWidth - rod2.offsetWidth)/2+'px';
//     ball.style.left=(windowWidht - ball.offsetWidth)/2+'px';

//     // if lose player gets the ball
//     if(rodName===rod1)
//     {
//         ball.style.top=(rod2.offsetTop-rod2.offsetHeight)+'px';
//         ballSpeedX=2;
//     }else if(rodName===rod2)
//     {
//         ball.style.top=(rod1.offsetTop+rod1.offsetHeight)+'px';
//         ballSpeedY=2;
//     }
...
//     {
//         maxscore=score;
//         localStorage.setItem(s_name,rod);
//         localStorage.setItem(s_score,maxscore);
//     }
//     clearInterval(movement);
//     resetBord(rod);

//     alert(rod+"win with a score of "+(score*100)+".Max score is:"+(maxscore*100));
// }
